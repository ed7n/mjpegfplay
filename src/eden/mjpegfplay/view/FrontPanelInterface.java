...
/**
 *  A {@code FrontPanelInterface} hides the {@code JComponent} definition from
 *  a {@code FrontPanel} to simplify its interface to presenters.
 *  <p>
...
//~~~~MUTATORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Sets the texts of this {@code FrontPanel}. For each text represented as
     *  a parameter, passing a {@code null} retains its value.
     */
    ...
    /**
     *  Sets the indicator pins of this {@code FrontPanel}. For each indicator
     *  pin represented as a parameter, passing {@code 0} sets it to low, {@code
     *  1} sets it to high, and others retain its value.
     */
...
//~~~~PREDICATES~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns whether the WAIT indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isWait();
    ...
    /**
     *  Returns whether the PAUSE indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isPause();

    /**
     *  Returns whether the SCAN indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isScan();
    ...
    /**
     *  Returns whether the FLOAT indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isFloating();

    /**
     *  Returns whether the LOOP indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isLoop();

    /**
     *  Returns whether the MUTE indicator pin of this {@code FrontPanel} is
     *  high
     */
    boolean isMute();
