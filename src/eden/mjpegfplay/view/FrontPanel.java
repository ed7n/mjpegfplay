...
//~~OBJECT FIELDS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private StringBuilder stringBuilder = new StringBuilder(TEXT_LENGTH);
...
//~~PRIVATE OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private void drawTexts(Graphics2D g) {
        ...
        g.drawString(formatToPanel(this.text1, true ), 18, Y_TEXT     );
    }
    ...
    private String formatToPanel(String string, boolean leanRight) {
        ...
        byte spacesRght =
            (byte) (TEXT_LENGTH - string.length() - spacesLeft);
