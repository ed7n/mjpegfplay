 ...
 *  not greater or equal to the previous point, or is outside the range of
 *  points for its {@code Sequence}. Check and correct any offending freeze
 *  points that meet any of the aforementioned criteria.
 *
 *  @author     Brendon
...
public class BadFreezePointException extends MalformedSequenceException {
    ...
    /**
     *  Makes a {@code BadFreezePointException} with the given freeze point as
     *  its detail message
     */
