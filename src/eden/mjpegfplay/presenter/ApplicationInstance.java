...
/**
 *  An {@code ApplicationInstance} represents an instance of this application.
 *  It manages retrievals, presentations, modifications, and storage of end user
 ...
 *  user.
 *  <p>
 *  This class represents the presenter in the model-view-presenter
...
//~~~~ACCESSORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns the number of frames to render per second for the currently
     *  loaded sequence
     */
    public byte getRate() {
    ...
    /**
     *  Returns the number of frames to advance for the currently loaded
     *  sequence
     */
    public int getSkip() {
...
//~~~~PREDICATES~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns whether changes to the currently loaded sequence are not yet
     *  saved to non-volatile memory
     */
