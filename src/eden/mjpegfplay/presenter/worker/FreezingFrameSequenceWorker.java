 ...
 *  FileFrameSequence} and its A/V data workers in accordance to playback
 *  states.
 *  <p>
...
//~~OBJECT FIELDS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Indicates whether this FreezingFrameSequenceWorker is freezing its
     *  Sequence
     */
    ...
    /**
     *  Actual number of frames to skip per render that is not affected by
     *  freezing
     */
    private int skip;
...
//~~PRIVATE OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private void updateSpecial(int position, boolean sync) {
            ...
            this.freezing.compareAndSet(false, true))
        {
            ...
            sync = true;
                 ...
                 this.freezing.compareAndSet(true, false))
        {
            this.sequence.setSkip(this.skip);
            sync = true;
        }
    ...
    private int searchFreezePoint(int position) {
        for (int i = 0; i < this.freezePoints.size(); i += 2) {
            if (position >= this.freezePoints.get(i) &&
...
//~~~~CONSTRUCTOR HELPERS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns an immutable List of freezing intervals from the metadata file
     *  in the directory pointed by the path of this FreezingSequenceWorker
     */
        ...
        MalformedSequenceException
    {
        ...
        for (int i = 0; i < freezePoints.size(); i++) {
            ...
            if ((i > 0 && freezePoint < out.get(i - 1)) ||
