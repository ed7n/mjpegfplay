...
//~~CONSTRUCTORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Makes a {@code MusicPlaylistWorker} with the given {@code Presenter}
        ...
        else if (this.sequence.getSkip() == FAST_REWIND)
        {
            ...
            if (position == 0) {
                if (this.sequence.getPoint() == this.sequence.getStart()) {
                    ...
                    this.track.skip(this.track.getStreamSize() + (
                        this.track.getFormat().getFrameSize() *
                        4800 *
                        FAST_REWIND
                    ));
                }
...
//~~~~CONSTRUCTOR HELPERS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns a SimpleSyncroTimer that handles end-of-track detection and
