...
/**
 *  A {@code SequenceWorker} manages a {@code Sequence} and its A/V data
 *  workers in accordance to playback states.
 *  <p>
 *  In the file system, a {@code Sequence} is a directory containing its
 *  metadata file and A/V data.
 *
 *  @author     Brendon
...
public interface SequenceWorker {
    ...
    /**
     *  Configures this {@code SequenceWorker} to advance one point forward
     *  every update
     */
    void play();
    ...
    /**
     *  Configures this {@code SequenceWorker} to not advance frames every
     *  update, and rewinds to the starting point.
     */
    void stop();
    ...
    /**
     *  Advances one point backward only if this {@code SequenceWorker}
     *  does not advance frames every update
     */
    void stepBackward();

    /**
     *  Advances one point forward only if this {@code SequenceWorker} does
     *  not advance frames every update
     */
    void stepForward();
    ...
    /**
     *  Configures this {@code SequenceWorker} to advance one point
     *  backward every update
     */
    void trickPlay();

    /**
     *  Stops all activities and frees as much system resources allocated to
     *  this {@code SequenceWorker} as possible
     */
    void dismiss();
...
//~~~~ACCESSORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     *  SequenceWorker}. The {@code List} may contain {@code null} to
     *  denote the absence of an audio track associated to the track number
     *  given by the index. The actual type to be returned is an {@code
     *  ArrayList}.
     */
...
//~~~~MUTATORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Toggles whether the {@code OutputMixer} of this {@code SequenceWorker}
     *  is muted ans returns its new value
     */
    boolean toggleMuted();

    /**
     *  Configures the {@code OutputMixer} of this {@code SequenceWorker}
     *  to output the given audio track
     *
     *  @param      track
     *              Sole channel to output. Zero or negative values cause all
...
//~~~~PREDICATES~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns whether the {@code OutputMixer} of this {@code SequenceWorker}
     *  is muted
     */
    boolean isMuted();
}
