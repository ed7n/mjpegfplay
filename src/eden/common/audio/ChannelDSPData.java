...
public class ChannelDSPData {
  ...
  /**
   * Makes a {@code ChannelDSPData} with the given amplification factor and mute
   * flag
   */
  ...
  /**
   * Resets this {@code ChannelDSPData} to the default manipulation parameters
   */
  public void reset() {
  ...
  /**
   * Sets whether the defined channel(s) of this {@code ChannelDSPData} is/are
   * muted
   */
