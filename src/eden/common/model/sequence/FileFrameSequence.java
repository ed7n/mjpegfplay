...
//~~CONSTRUCTORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     *              If any of the numerical arguments are malformed
     */
...
//~~~~OPERATORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns whether the given {@code FileFrameSequence} is equivalent to
     *  this
     */
    public boolean equals(FileFrameSequence s) {
        return
            s != null                          &&
            s.extension.equals(this.extension) &&
            super.equals(s);
    }
}
