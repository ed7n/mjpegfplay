 ...
 *  its fixed-capacity FIFO buffer at any pace. Any object with it as a field
 *  can then retrieve the buffered data chunks at its pace. This reduces the
...
//~~OBJECT FIELDS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Indicates whether this ReadAheadLens was unrecoverably thrown an
     *  Exception
     */
...
//~~CONSTRUCTORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Makes an {@code ReadAheadLens} with the default buffer capacity in
    ...
    /**
     *  Makes an {@code ReadAheadLens} with the given buffer capacity in number
     *  of data chunks
     */
...
//~~OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    */
    ...
    /**
     *  Removes all data chunks from the FIFO buffer of this {@code
     *  ReadAheadLens}
     */
...
//~~~~ACCESSORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Returns the buffer capacity of this {@code ReadAheadLens} in number of
     *  data chunks
     */
     ...
     *
     *              {@code null}
     *              If this {@code ReadAheadLens} is not dead
     */
