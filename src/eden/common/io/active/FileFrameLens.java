...
/**
 *  A {@code FileFrameLens} reads and decodes image files into its
 *  fixed-capacity FIFO buffer with an identifier for each.
 *
 *  @author     Brendon
...
//~~OBJECT FIELDS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Indicates whether this FileFrameLens is signalled for a change in
     *  behavior
     */
...
//~~~~ACCESSORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     *  front most {@code Frame} is {@code null}, then the maximum {@code int}
     *  is returned.
     */
...
//~~PRIVATE OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private void updateBufferingParameters() {
        this.frame = this.sequence.getPoint() +
            (this.sequence.getSkip() * this.offsetFrame);
