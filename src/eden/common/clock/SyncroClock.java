...
//~~PUBLIC OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Stops the {@code Timer} of this {@code SyncroClock}. This causes it to
    ...
    /**
     *  Stops and resets this {@code SyncroClock}. This causes its {@code Timer}
     *  to stop sending {@code ActionEvents} to its listeners.
     */
    @Override
    public void stop() {
        this.timer.stop();
    ...
    /**
     *  Restarts the {@code Timer} of this {@code SyncroClock}. This cancels
     *  any pending firings and causing it to fire immediately.
     */
    public void restart() {
        this.timer.restart();
    }
    ...
    /**
     *  Fires an {@code ActionEvent} to the {@code ActionListeners} registered
     *  on the {@code Timer} of this {@code SyncroClock}
     */
    @Override
    public void tick() {
