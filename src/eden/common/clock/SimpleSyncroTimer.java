...
//~~CONSTRUCTORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Makes a {@code SimpleSyncroTimer} with the given {@code Runnable} and
     *  the default fire rate of {@value #DEFAULT_FIRE_RATE}
     */
...
//~~PUBLIC OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     *  {@code Thread}, although it should be noted that {@code
     *  SimpleSyncroTimers} have their own {@code Thread} to run on.
     */
    @Override
    public void run() {
    ...
    /**
     *  Interrupts the {@code Thread} on which this {@code SimpleSyncroTimer}
     *  runs
     */
    public void end() {
...
//~~~~MUTATORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Sets the number of fires per second for this {@code
     *  SimpleSyncroTimer}
     */
    @Override
