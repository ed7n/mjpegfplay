...
/**
 * The {@code CSSColor} class defines {@code Colors} listed in the CSS Color
 * Module Level 3 specification by the W3C. However, minute adjustments to the
 * sRGB values for some basic colors have been done to address--in the
 * subjective perspective of the author--a misconception in 25, 50 and 75
 * percentile calculations.
 * <p>
 * The latest version of this specification can be found
 * [<a href="https://www.w3.org/TR/css-color-3/">here</a>], while the version
 * from which this release follows (20180619) can be found
 * [<a href="https://www.w3.org/TR/2018/REC-css-color-3-20180619/">here</a>].
 * <p>
 * Static {@code Colors} of this class are symbolically backwards compatible to
 * Java's {@code Color} (version "10 Feb 1997"). Name conflicts on some
 * extended/X11 colors are resolved by prepending "X11_" to their identifiers.
 *
 * @author Brendon
...
public class CSSColor {
  ...
  public static final Color SILVER = LIGHT_GRAY;
  ...
  public static final Color LIME = GREEN;
  ...
  public static final Color BISQUE = new Color(225, 228, 196);
  ...
  public static final Color X11_DARK_GRAY = new Color(169, 169, 169);

  public static final Color X11_DARK_GREEN = new Color(0, 100, 0);

  public static final Color X11_DARK_GREY = X11_DARK_GRAY;
  ...
  public static final Color DARK_ORCHID = new Color(150, 50, 204);
  ...
  public static final Color X11_LIGHT_GRAY = new Color(250, 211, 211);

  public static final Color LIGHT_GREEN = new Color(144, 238, 144);

  public static final Color X11_LIGHT_GREY = X11_LIGHT_GRAY;
