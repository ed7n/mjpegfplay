...
public class ImageRenderer extends EDENRenderer {
  ...
  /**
   * Makes an {@code ImageRenderer} with the given name, {@code ReadAheadLens},
   * and rendering aspect ratio.
   */
  ...
  /**
   * Flips the rendering aspect ratio of this {@code ImageRenderer}. This may be
   * called upon display orientation changes.
   */
