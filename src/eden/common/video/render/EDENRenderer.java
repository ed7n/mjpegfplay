...
public abstract class EDENRenderer {
  ...
  /**
   * Draws the graphical element(s) of this {@code EDENRenderer} with the given
   * {@code Graphics2D}
   */
  ...
  /**
   * Removes the given {@code RendererComponent} from this {@code EDENRenderer}
   *
   * @return {@code true} If the given {@code RendererComponent} was found and
   * is successfully removed;
   *
   * {@code false} If the given {@code RendererComponent} was not found or is
   * {@code null}
   */
  ...
  public boolean equals(EDENRenderer r) {
    return r != null && r.name.equals(this.name);
  }
}
