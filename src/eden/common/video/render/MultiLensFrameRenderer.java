...
//~~PUBLIC OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /**
     *  Updates the {@code Frame} of this {@code MultiLensFrameRenderer} to
     *  reflect its latest state
     */
    @Override
    ...
    /**
     *  Draws the {@code Frame} of this {@code MultiLensFrameRenderer} with
     *  the given {@code Graphics2D}
     */
    @Override
...
//~~~~ACCESSORS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     *              If the {@code Frame} of this {@code MultiLensFrameRenderer}
     *              is {@code null}
     */
    public synchronized int getFrame() {
        return this.frame == null ?
            Integer.MIN_VALUE : this.frame.getIdentifier();
    }

    /**
     *  Returns the rendering aspect ratio of this {@code
     *  MultiLensFrameRenderer}
     */
...
//~~PRIVATE OBJECT METHODS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    private boolean setNextLens() {
        ...
        for (FileFrameLens l : this.lenses) {
            int identifier = l.getNextIdentifier();

            /*
            if (identifier < smallestIdentifier && (this.frame == null ||
                identifier > this.frame.getIdentifier()))
            {
            ...
            */
            if (identifier < smallestIdentifier) {
                smallestIdentifier = identifier;
                this.lens = l;
            }
        }
        return smallestIdentifier != Integer.MAX_VALUE;
    }
                                             ...
                                             long time)
    {
        g.drawString(
            ...
            "  Output: " + width + "×" + height +
            "  Source: " + this.frame.getImage().getWidth(null) + "×" +
        ...
        g.drawString(
            "Lens : " + this.lenses.indexOf(this.lens) + "/" +
            this.lenses.size(),
        1, 43);
